  ...
  return (
    <div>
      ...
      <div className="flex justify-center my-6">
        <Link to={"/apps"}>
          <button className="relative px-6 py-2 font-semibold text-white bg-gradient-to-r from-purple-700 to-purple-400 rounded-md hover:opacity-90 transition-all duration-300">
            Show All
          </button>
        </Link>
      </div>
